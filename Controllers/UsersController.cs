...
namespace ProductsAPI.Controllers
{
    ...
    public class UsersController: ControllerBase
    {
        ...
        //configurationdan bilgi almak için burada inject etmemiz gerekiyor.
        ...
        public async Task<IActionResult> Login(LoginDTO model)
        {
            ...
            //403 state kodu, yetkinizin olmadığını söyler.
            return Unauthorized();
        }
        ...
        private object GenerateJWT(AppUser user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddDays(1), // Bir gün sonra süresi bitecek olan bilgi.
                SigningCredentials = new SigningCredentials(new SymmetricSecurityKey(key), SecurityAlgorithms.HmacSha256Signature),
                Issuer = "denizkalender.com"
            };
